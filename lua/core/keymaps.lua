...
keymap.set("n", "<leader>cn", ":cn<CR>zz")
keymap.set("n", "<leader>cp", ":cp<CR>zz")
...
keymap.set("n", "<leader>dh", ":DiffviewFileHistory --range=HEAD~10..HEAD<CR>")
keymap.set("n", "<leader>dr", ":DiffviewRefresh<CR>")
keymap.set("n", "<leader>df", ":DiffviewFileHistory %<CR>")
keymap.set("n", "<leader>ds", ":DiffviewFileHistory -g --range=stash<CR>")
